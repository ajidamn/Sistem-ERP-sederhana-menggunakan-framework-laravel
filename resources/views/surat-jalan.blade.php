                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                          <div class="row">
                                            <div class="col-lg-6">
                                              <label>Stock</label>
                                              <input id="tambah-stock-barang" step="any" class="form-control" type="number" min="1" required readonly>
                                              <label> Satuan</label>
                                          ...
                                          <div class="row">
                                            <div class="col-lg-12" id="pemindahan">
                                                ...
                                                <select id="tambah-gudang-tujuan-barang" class="form-control select2" style="width:100% ;" required></select>
                                            </div>
                                          </div>
                                        </div>
                                  ...
                                  <div class="row" id="edit-barang">
                                    <form id="edit-tambah-barang">
                                      <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                          <label>Stock</label>
                                          <input id="edit-stock-barang" step="any" class="form-control" type="number" min="1" required readonly>
                                          <label> Satuan</label>
                            ...
                            <div class="row" id="edt-tambah-barang">
                              <form id="edt-form-tambah-barang">
                                <div class="row">
                                  ...
                                  <div class="col-lg-2">
                                    <label>Stock</label>
                                    <input id="edt-tambah-stock-barang" step="any" class="form-control" type="number" min="1" required readonly>
                                    <label> Satuan</label>
                            ...
                            <div class="row" id="edt-edit-barang">
                              <form id="edt-edit-tambah-barang">
                                <div class="row">
                                  ...
                                  <div class="col-lg-2">
                                    <label>Stock</label>
                                    <input id="edt-edit-stock-barang" step="any" class="form-control" type="number" min="1" required readonly>
                                    <label> Satuan</label>
                                    <input id="edt-edit-satuan-barang" class="form-control" type="text" readonly>
                                  </div>
                                  <div class="col-lg-2">
                                    <label>QTY</label>
                                    <input id="edt-edit-qty-barang" step="any" class="form-control" type="number" min="1" required >  
                                  </div>
                                  <div class="col-lg-4">
                                    <label>Keterangan</label>
                                ...
                                <div class="row">
                                  <div class="col-lg-4">
                                    <label>Kode Akun Debit</label>
                                    <select id="edt-edit-debit-barang"  class="form-control select2 "  style="width: 100%" >
                                    </select>
                                  </div>
                                  <div class="col-lg-4">
                                    <label>Kode Akun Kredit</label>
                                    <select id="edt-edit-kredit-barang"  class="form-control select2 "  style="width: 100%" >
                                    </select>
                                  </div>
                                  <div class="col-lg-4">
                                    <br>
