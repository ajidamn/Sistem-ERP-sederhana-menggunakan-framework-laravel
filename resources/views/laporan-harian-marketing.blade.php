            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body table-responsive" >
                  <input id="user" type="text" value="{{$user->kode_karyawan}}" hidden>
                  <table id="table-laporan" class="table  table-striped">
                    <thead>
                    <tr>
                      <th>Action</th>
                      <th>Tanggal</th>
                      <th style="width:50%;">Laporan</th>
                      <th>Status</th>
                    </tr>
                    </thead>
                    <tbody>
            ...
            <form id="form-tambah">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-lg-6">
                    <label> Nama Marketing</label>
                    <input id="tmb-marketing" hidden type="text" value="{{$user->kode_karyawan}}">
                    <input id="tmb-nama-marketing" type="text" class="form-control" disabled value="{{$detail->nama}}">
                  </div>
                  <div class="col-lg-6">
                    <label> Tanggal </label>
  ...
  $(document).ready(function() {   
    ...
    $('#table-laporan').DataTable({
      ...
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
        processing: true,
        serverSide: true,
        ajax: '{!! url("data-lapmarketing/'+user+'") !!}',
        columns: [   
