                                  ...
                                  <div class="col-lg-4">
                                    <div class="row">
                                      <div class="col-lg-6">
                                        ...
                                        <input type="number" step="any" class="form-control" id="tambah-harga-barang" required hidden>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>Satuan</label>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <label>Diakui</label>
                                        <input id="tambah-diakui-barang" step="any" class="form-control" type="number" min="0" required>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>Dikirim</label>
                                        <input id="tambah-dikirim-barang" step="any" class="form-control" type="number" min="0" required >
                                      </div>
                                    </div>  
                                  </div>
                                  <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        ...
                                        <input id="tambah-diterima-barang" step="any" class="form-control" type="number" min="0" >
                                      </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                        ...
                                        <input type="text" step="any" class="form-control" id="tambah-hpp-barang" hidden>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-12">
                              ...
                              <form id="form-edit-barang">
                                <div class="row">
                                  <div class="col-lg-4">
                                      ...
                                      <label>Gudang</label>
                                      <select class="form-control select2" id="edit-gudang-barang"></select>
                                      <label>Debit</label>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="row">
                                      <div class="col-lg-6">
                                        ...
                                        <input id="edit-harga-barang" step="any" class="form-control" type="number" min="0" hidden>
                                        <label>Diakui</label>
                                        <input id="edit-diakui-barang" step="any" class="form-control" type="number" min="0" required>
                                        <label>Stock</label>
                                        <input type="number" step="any" class="form-control" id="edit-stock-barang" readonly>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>Satuan</label>
                                        <input id="edit-satuan-barang" class="form-control" type="text" readonly>
                                        <label>Dikirim</label>
                                        <input id="edit-dikirim-barang" step="any" class="form-control" type="number" min="0" required >
                                        <label>HPP</label>
                                        <input type="text" class="form-control" id="edit-hppbarang" readonly>
                                        <input type="number" step="any" class="form-control" id="edit-hpp-barang" hidden>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                      ...
                                      <div class="row">
                                        <div class="col-lg-6">
                                          <label >Diterima</label>
                                          <input id="edit-diterima-barang" step="any" class="form-control" type="number" min="0" >
                                        </div>
                                        <div class="col-lg-6"></div>
                                      </div>
                                      <label>Keterangan</label>
                      ...
                      <div class="col-lg-9">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            ...
                            <label>Keterangan</label>
                            <textarea  id="edt-keterangan-inv" class="form-control" row="" style="resize: none;" ></textarea>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-8"></div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="row">
                                      <div class="col-lg-6">
                                        ...
                                        <input type="number" step="any" class="form-control" id="edt-tambah-harga-barang" hidden>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>Satuan</label>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <label> Diakui</label>
                                        <input type="number" step="any" id="edt-tambah-diakui-barang" class="form-control" required>
                                      </div>
                                      <div class="col-lg-6">
                                        <label> Dikirim</label>
                                        <input type="number" step="any" id="edt-tambah-dikirim-barang" class="form-control" required>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <label >Diterima</label>
                                        <input id="edt-tambah-diterima-barang" step="any" class="form-control" type="number" min="0" >
                                      </div>
                                      <div class="col-lg-6"></div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                        ...
                                        <input type="number" step="any" class="form-control" id="edt-tambah-hpp-barang" hidden>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-12">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="row">
                                      <div class="col-lg-6">
                                        ...
                                        <input type="number" step="any"  class="form-control" id="edt-edit-harga-barang" hidden>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>Satuan</label>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <label>Diakui</label>
                                        <input id="edt-edit-diakui-barang" step="any" class="form-control" type="number" min="0" required>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>Dikirim</label>
                                        <input id="edt-edit-dikirim-barang" step="any" class="form-control" type="number" min="0" required >
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <label>Stock</label>
                                        <input id="edt-edit-stock-barang" step="any" class="form-control" type="number" min="0" required>
                                      </div>
                                      <div class="col-lg-6">
                                        <label>HPP</label>
                                        <input type="text" class="form-control" id="edt-edit-hppbarang" readonly>
                                        <input id="edt-edit-hpp-barang" step="any" class="form-control" type="number" min="0" hidden>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <label >Diterima</label>
                                        <input id="edt-edit-diterima-barang" step="any" class="form-control" type="number" min="0" >
                                      </div>
                                      <div class="col-lg-6"></div>
                                    </div>
                                    <div class="row">
                  ...
                  <div class="col-lg-9">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        ...
                        <label>Keterangan</label>
                        <textarea  id="dtl-keterangan-inv" class="form-control" row="" style="resize: none;" disabled></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-3">
                    ...
                    <div class="card card-outline card-info">
                      <div class="card-header">
                        <div class="row justify-content-between col-lg-12">
                          <label> Detail Barang Invoice </label>
                          <a id="cetak-inv" rel="noopener" target="_blank" class="col-sm-2 form-control btn btn-danger"><i class="fas fa-print"></i> Print</a>
                        </div>
                      </div>
                      <div class="card-body">
                        <table  class="table table-responsive table-bordered table-striped">
    ...
    <script>
          ...
          $('#tambah-nama-barang').on('change',function(){
            ...
            $.ajax({
              ...
              success:function(response){
                console.log(response)
                if(response.success == true) {
                  $('#tambah-hppbarang').val(formatRupiah(response.data));
              ...
              success : function(response){
                ...
                $.ajax({
                  ...
                  success:function(response){
                    console.log(response)
                    if(response.success == true) {
                      $('#edit-hppbarang').val(formatRupiah(response.data));
          ...
          $.ajax({
            ...
            success : function(response){
              ...
              if(response.success == true){
                ...
                } else if(response.data.sj.status =='Sudah Diperiksa'){
                  $('#edit-nama-pembuat').html(response.data.author.creator.nama);
                  $('#edit-create-pembuat').html(response.data.author.created_at);
              ...
              success : function(response){
                ...
                $.ajax({
                  ...
                  success:function(response){
                    console.log(response)
                    if(response.success == true) {
                    $('#edt-edit-hppbarang').val(formatRupiah(response.data));
                      $('#edt-edit-hpp-barang').val(response.data);
                    } else {
                      Toast.fire({
                        icon  :'error',
                        title : response.pesan,
      ...
      // Detail Invoice
        ...
        $('#cetak-inv').on('click',function(){
          var kode = $('#dtl-kode-inv').val();
          location.href = 'cetak-invoice?kode='+kode;
        });
      // Detail Invoice
      // Selesai Invoice
      ...
      function tabelINVdetail(kode){
        $.ajax({
          ...
          success : function(response){
            ...
            var row = $("<tr><td colspan='18' align='center'>Total</td><td><b>"+formatRupiah(sum)+"</b></td></tr>");
            datahandler.append(row);
