...
class RekananController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $rekanan->bank = $request->bank1;
            // $rekanan->bank2 = $request->bank2;
    ...
    public function edit($kode)
    {
        ...
        try{
            ...
            if($data->marketing == "-" OR $data->marketing == ""){
                return response()->json(['success'=>true,'result'=> $data]);    
            } else {
                $karyawan = karyawan::select('nama')->where('kode',$data->marketing)->first();
                $data->marketing = $karyawan->nama;
                return response()->json(['success'=>true,'result'=> $data]);
            }
        } catch(\Exception $e){
            return response()->json(['success'=>false, 'pesan'=>$e->getMessage()]);
    ...
    public function update(Request $request, $kode)
    {
        ...
        try{
            ...
            'email' => $rekanan->email,'alamat' =>$rekanan->alamat ]);
