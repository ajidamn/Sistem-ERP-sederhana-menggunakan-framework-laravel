              ...
              <div class="modal-body">
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">
                              ...
                              {{-- <label> Mitra</label>
                              <input id="detail_mitra"class="form-control" type="text" readonly> --}}
                              <label>Nama Rekanan </label>
                              <input id="detail_nama" class="form-control" type="text" readonly>
                              <label>Nomor Rekanan (WA)</label>
                              <input id="detail_cp" class="form-control" type="text" onkeypress="return angka('evt')" maxlength="12" readonly>
                              <label>Rek. Bank 1</label>
                              <input id="detail_bank1" class="form-control" type="text" onkeypress="return angka('evt')" maxlength="16" readonly>
                          </div>
                      </div>
                      <div class="col-lg-4">
                          <div class="form-group">
                      ...
                      <div class="col-lg-4">
                          <div class="form-group">
                              {{-- <label> Marketing</label>
                              <input id="detail_marketing" class="form-control" type="text" readonly> --}}
                              <label>Alamat</label>
                              <textarea id="detail_alamat" class="form-control" rows="5" placeholder="Alamat Lengkap"" readonly></textarea>
                          </div>
                      </div>
                      </div>
              </div>
  ...
  $('#form-edit').submit(function(e){
    ...
    $.ajax({
      ...
      data : {
        ...
        wa        : $('#edit_cp').val(),
        bank1     : $('#edit_bank1').val(),
        email     : $('#edit_email').val(),
        perusahaan : $('#edit_perusahaan').val(),
        telp      : $('#edit_telp').val(),
        // fax       : $('#edit_fax').val(),
        // bank2     : $('#edit_bank2').val(),
        // marketing : $('#edit_marketing').val(),
