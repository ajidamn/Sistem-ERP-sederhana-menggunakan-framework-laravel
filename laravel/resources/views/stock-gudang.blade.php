      ...
      success   : function(response){
        ...
        $('#table-stock').DataTable({
          ...
          columns : [
            ...
            { data: 'awal_nilai', name: 'awal_nilai',orderable:false},
            { data: 'masuk_qty', name: 'masuk_qty',orderable:false},
            { data: 'masuk_nilai', name: 'masuk_nilai',orderable:false},
            { data: 'keluar_qty', name: 'keluar_qty',orderable:false},
            { data: 'keluar_nilai', name: 'keluar_nilai',orderable:false},
            { data: 'akhir_qty', name: 'akhir_qty',orderable:false},
            { data: 'akhir_nilai', name: 'akhir_nilai',orderable:false},
          ],
        });
      }
    })
