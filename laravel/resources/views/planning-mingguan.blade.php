            ...
            <form id="form-tambah">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-lg-6">
                    <label> Nama Marketing</label>
                    <input type="text" id="tmb-marketing" value="{{$user->kode_karyawan}}" hidden >
                    <input type="text" id="tmb-nama-marketing" value="{{$detail->nama}}" disabled >
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
    ...
    $('#table-planning').DataTable({
      ...
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
        ...
        columns: [   
            ...
            { data: 'awal', name: 'awal',orderable:true},
            { data: 'akhir',name: 'akhir',orderable:true},
